...
var dbPath = import_path.default.join(process.cwd(), "server", "quoter.db");
var db;
try {
...
async function runImport() {
  try {
    const rawData = import_fs.default.readFileSync(import_path2.default.join(process.cwd(), "server", "demo_data.json"), "utf8");
